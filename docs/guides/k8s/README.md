...
Now that you have the `llama32-3b.yaml` report, you can follow the ["Analyzing Results" section](../example-runs/README.md#analyzing-results) to gain insights from your LLM
deployments.

#### View Analysis Locally

To view the generated benchmark plots locally, run
